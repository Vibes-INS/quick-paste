...
const NoteCard: React.FC<Props> = ({
  ...
  const copyIcon = folded
    ...
    : ''
  return <div className={`${editingClassName} border rounded-md p-3 w-full relative pr-10 text-gray-700 dark:border-gray-700 dark:bg-black dark:text-gray-100 animation-opacity`}>
    {
      isEditing
        ? <textarea
